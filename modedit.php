...
if ($mform->is_cancelled()) {
    ...
    if (isset($fromform->submitbutton)) {
        ...
        if (empty($fromform->showgradingmanagement)) {
            ...
            $recordtoinsert->badkan_course_name = $fromform->course_name;
            $recordtoinsert->badkan_assignment= $fromform->assignment_name;
            $recordtoinsert->moodle_course_name = $COURSE->id;
            $recordtoinsert->moodle_assignment = $fromform->name;
            $DB->insert_record('badkan_course', $recordtoinsert);
            redirect($url);
        } else {
            $recordtoinsert = new stdClass();
            $recordtoinsert->user_id= $USER->id;
