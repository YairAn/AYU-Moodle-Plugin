...
class mod_assign_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'course_name', 'badkan course name'); // Add elements to your form
        $mform->setType('course_name', PARAM_TEXT);                   //Set type of element
        $mform->addHelpButton('course_name', 'badkancoursename', 'assign');

        $mform->addElement('text', 'assignment_name', 'badkan assignment name'); // Add elements to your form
        $mform->setType('assignment_name', PARAM_TEXT);                   //Set type of element
        $mform->addHelpButton('assignment_name', 'badkanassignname', 'assign');
