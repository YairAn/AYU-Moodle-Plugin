...
$string['badkanemail'] = 'enter the email you registered to the badkan';
$string['badkanpassword'] = 'enter the password you registered to the badkan';
$string['githuburl'] = 'the link to your Github repository where your assignment is';

$string['badkancoursename'] = 'course name';
$string['badkanassignname'] = 'assignment name';

$string['badkancoursename_help'] = 'only for badkan assignment - the course name like named in the badkan system';
$string['badkanassignname_help'] = 'only for badkan assignment - the assignment name like named in the badkan system';
